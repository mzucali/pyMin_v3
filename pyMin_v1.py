...
#  SPECIFIC
from mincalclib import mineral_constants, dataset, conversion
...
def main():
    ...
    print("file folder: ", os.path.dirname(os.path.realpath(sys.argv[0])))
    ...
    label_root = Label(root, text="Mineral Formula Calculation \n\n michele.zucali@unimi.it\n\n\n "
                                  "The Vertical Version - Dec 2022 \n\n pyMin v.3.2 - Michele Zucali 2022\n\n\n\n\n")
    label_root.pack()

    app = Example()
    #  Mineral labels and oxigens WINDOW
    label_window = Toplevel(root)
    label_window.geometry('370x600+30+30')
    display_mineral = Label(label_window,
                            text="Mineral Labels and Oxigens!")
    ...
    output_display.geometry('740x400+800+30')
    ...
    def UploadAction(event=None):
        ...
        print("pyMinCalc.log")
        global ds
        ds = dataset.dataset(root.filename)# RUN dataset.dataset sul filename INPUT
    ...
    def convertAX(event=None):
        ...
        ###############BUTTONS
    Button(root, text="Select the File & Run", command=UploadAction).pack()
    Button(root).pack()
    Button(root).pack()
    Button(root, text="Plot Data Results", fg='blue', activebackground='#00ff00',
